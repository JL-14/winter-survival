...
feedback_dict = {
    ...
    8 : 'A 20 x 20 ft. piece of heavy-duty canvas: \n"The cold makes shelter necessary, and canvas would protect against wind and snow (canvas is used in making tents). Spread on a frame made of trees, it could be used as a tent or a wind screen. It might also be used as a ground cover to keep the survivors dry. It’s shape, when contrasted with the surrounding terrain, makes it a signaling device." The expert ranked this item as 5.\n',
    9 : 'A sectional air map made of plastic: \n"This is also among the least desirable of the items because it will encourage individuals to try to walk to the nearest town. It’s only useful feature is as a ground cover to keep someone dry." The expert ranked this item as 12.\n',
    ...
    11 : 'A compass: \n"Because a compass might encourage someone to try to walk to the nearest town, it is a dangerous item. It’s only redeeming feature is that it could be used as a reflector of sunlight (due to its glass top)." The expert ranked this item as 11.\n',
