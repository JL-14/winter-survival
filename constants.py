...
4. While escaping from the plane you saw twelve items, but you can only manage to take five out of the planewreck. Your task is to select five of the items and rank these five items according to their importance for your survival (1 being the most important, 2 the second most important, and so on). You can change your mind about which items to take ONLY ONCE.
...
4. Finally, there are no absolutely right answers, and in real life your ability to use the items chosen will affect their usefulness. You may therefore not agree with the exact rankings the expert has given, but the items ranked highest by the expert would unquestionably give you a chance of survival in this environment.
"""
...
expert_list = [
    ...
    ['2', 'A ball of steel wool'],
    ['3', 'Extra shirt and trousers'],
    ['4', 'Tin of coconut oil'], ['5', 'A 20 x 20 ft. piece of heavy-duty canvas'],
    ['6', 'A small axe'],
    ['7', 'A family-size chocolate bar'],
    ['8', 'A newspaper'],
    ['9', 'A loaded .45-caliber pistol'],
